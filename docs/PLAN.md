...
- [x] Печать путевых листов по шаблону `Templates/Путевой лист.docx` — пачкой, по странице на машину, лицевые и обороты двумя файлами.
...
| Шаблон Word правят и ломают плейсхолдеры | документ печатается с `{{ЦЕЛЬ}}` вместо значения | незаполненные плейсхолдеры вычищаются, в бумаге остаётся пустое место; исходные шаблоны лежат в репозитории |
